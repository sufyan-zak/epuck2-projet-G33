...
#define CITY_INITIALISATION_H_
	     ...
	     struct Noeud nd2 = {.uid=1, .tab_liens={0,2,5, no_link}, .tab_liens_dist = {35.52, 17.85, 47.26, no_link}};
	     ...
	     struct Noeud nd6 = {.uid=5, .tab_liens={1, 4, 6, 9,no_link}, .tab_liens_dist = {2, 62.87, 23.93,8.73, no_link} };

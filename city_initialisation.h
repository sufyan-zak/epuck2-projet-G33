/*
 * city_initialisation.h
 *
 *  Initializes the city, the user enters the nodes, the link table and  the link distance table
...
#define END_NODE 6
	 ...
	 struct Noeud nd2 = {.uid=1, .tab_liens={0,2, 5, no_link}, .tab_liens_dist = {35.52, 17.85, 65.71, no_link}};
	...
	// struct Noeud nd6 = {.uid=5, .tab_liens={1, 4, 6, 9, no_link}, .tab_liens_dist = {35.71, 62.87, 23.93,8.73, no_link} };
	 struct Noeud nd6 = {.uid=5, .tab_liens={1, 4, 6, 9, no_link}, .tab_liens_dist = {65.71, 62.87, 23.93,8.73, no_link} };
	 ...
	 struct Noeud *node_list[16] = {&nd1, &nd2, &nd3, &nd4,&nd5, &nd6, &nd7,&nd8,&nd9,&nd10,&nd11,&nd12,
									 &nd13,&nd14,&nd15,&nd16};
